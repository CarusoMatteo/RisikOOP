...
L'entry point dell'applicazione è il \texttt{Controller}, che si occupa di avviare il model, che eredita da \texttt{GameManager}, e le view registrate, che ereditano da \texttt{RisikoView}.
Siccome questo gioco è un gioco abbastanza modulare, si è ritenuta utile la realizzazione di una macchina a stati finiti.
