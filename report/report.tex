...
\begin{figure}[H]
	...
	\caption{UML del pattern Template Method per la validazione delle combo di carte con tipo uguale.}
\end{figure}
Usare un'interfaccia dedita proprio agli aggiornamenti della view. ogni volta che al model succede una cosa, il controller chiama i metodi dell'interfaccia per aggiornare la view
