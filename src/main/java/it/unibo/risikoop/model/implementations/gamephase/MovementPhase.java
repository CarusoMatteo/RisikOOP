 ...
 * The player selects a source territory, a destination territory, and the number of units to move.
 */
public class MovementPhase implements GamePhase {
     ...
     */
    public MovementPhase(TurnManager turnManager) {
    ...
    public void selectTerritory(Territory t) {
        ...
        Set<Territory> owned = p.getTerritories().stream().collect(Collectors.toSet());
