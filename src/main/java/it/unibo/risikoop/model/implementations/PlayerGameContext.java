...
/**
 * Represents the context of a player in a game, encapsulating the player and the game manager.
 * This record is used to pass player-specific information along with the game state.
 *
